...
(function () {
	 ...
	 */
	var _fastUnsafe_Function_bind_ =
		( // Detect V8 js engine
			global["opera"] // Opera
	...
	var _Element_prototype = global["Element"] && global["Element"].prototype || {};
	var _Node_prototype = global["Node"] && global["Node"].prototype || {};
	var S_ELEMENT_CACHED_CLASSLIST_NAME;
	var _document_createElement = _fastUnsafe_Function_bind_.call(
								...
								elementToFix.addEventListener = function (type, listener, useCapture) {
									...
									if (_addEventListener_dublicate_bug || implementation_stopImmediatePropagation) {
										...
										listener = implementation_stopImmediatePropagation ? (
											_[_eventsUUID] = _fastUnsafe_Function_bind_.call(implementation_stopImmediatePropagation, {
												_listener: listener,
												_this: this
											})
...
//[FF lt 9]
		if (!("parentElement" in _testElement)) {
			Object.defineProperty(_Element_prototype, "parentElement", {
				"get": function () {
...
// JSON.stringify (15.12.3).Object.create(f.prototype)
		if (!_Native_Date.prototype.toJSON
			...
			|| ~(function () {
				...
				try {
					return _Native_Date.prototype.toJSON.call({
